...
<!-- <div class="content-wrapper"> -->
    <div class="section-title">
        <h2 class="title">{{ __('Manage Templates') }}</h2>
        <a href="{{ route('admin.template.create') }}" class="primary-btn">+ {{ __('Template Create') }}</a>
    </div>
            ...
            <div class="section-wrap">
                <div class="table-waraper">
                    ...
                    <div class="table-responsive">
                        <table class="display search-datatable primary-table" id="templateTable"
                            data-url="{{ route('admin.template.datatable') }}">
                            <thead>
                            <tr>
                                <th class="keep-show">{{ __('Media') }}</th>
                                <th class="keep-show">{{ __('Title') }}</th>
                                <th class="keep-show">{{ __('Post Type') }}</th>
