...
<div class="section-title">
    <h2 class="title">{{ __('Template Create') }}</h2>
</div>
<form action="{{ route('admin.template.store') }}" method="POST" id="templateForm" enctype="multipart/form-data">
    @csrf
    <div class="create-post-wrap">
        ...
        <div class="create-post-center">
            ...
            <input type="hidden" name="post_type" id="template_post_type" value="{{ old('post_type', 'Feed') }}">
                    ...
                    <div class="post-footer-right">
                        <div class="btn-list mt-0">
                            ...
                            <button type="button" class="primary-btn" data-bs-toggle="modal"
                                data-bs-target="#TemplateSaveModal">Save Draft
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="primary-btn" id="saveTemplateSubmitBtn">Save Template</button>
                </div>
            </div>
        </div>
    </div>
...
<div id="template-config" data-ai-generate-url="{{ route('admin.ai.generate-content.submit') }}"
    data-ai-enabled="{{ ($ai_enabled ?? false) ? '1' : '0' }}" data-ai-upgrade-message="{{ $ai_upgrade_message ?? '' }}"
    data-allowed-providers='@json($allowedProviders ?? [])' style="display:none;"></div>
