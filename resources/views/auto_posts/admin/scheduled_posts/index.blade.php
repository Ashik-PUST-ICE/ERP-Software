...
<!-- <div class="content-wrapper"> -->
    <div class="section-title">
        <h2 class="title">{{ __('All Posts') }}</h2>
    ...
    <div class="section-wrap">
        ...
        <div class="table-waraper">
            <div class="search-input-wrap">
                ...
                <input type="text" class="search-input" id="searchData" placeholder="Search By Title..." />
            </div>
            <table id="scheduledPostTable" class="display search-datatable primary-table" data-url="{{ route('admin.all-posts.datatable') }}">
                <thead>
                    <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{ __('Are you sure you want to delete this scheduled post? This action cannot be undone.') }}
            </div>
...
@push('script')
<script src="{{ asset('admin/js/all-posts.js') }}"></script>
@endpush