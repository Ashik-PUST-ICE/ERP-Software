                        ...
                        <form class="ajax primary-form" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row gy-4">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="pb-40">
                                        <div class="upload-img-box profileImage-upload"
                                            ...
                                            <div class="icon">
                                                <img src="{{ asset('assets/images/icon/edit-2.svg') }}" alt="" />
                                            </div>
                                        ...
                                        <h4 class="fs-18 fw-500 lh-22 text-1b1c17 pb-20 mt-3">{{ __('Personal Info') }}
                                        </h4>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="pb-30">
                                        <div class="form-group">
                                            <label for="epFullName" class="form-label">{{ __('Full Name') }}<span
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="pb-30">
                                        <div class="form-group">
                                            <label for="epEmail" class="form-label">{{ __('Email') }}<span
                                                    class="required">*</span></label>
                                            <input type="email" class="form-control" id="epEmail"
                                                value="{{ $user->email }}" name="email" placeholder="{{ __('Email') }}"
                                                required />
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="pb-30">
                                            <div class="form-group">
                                                <label for="phoneNumber"
                                                    class="form-label">{{ __('Phone Number') }}<span
                                                        class="required">*</span></label>
                                        ...
                                        <div class="pb-30">
                                            <div class="form-group">
                                                ...
                                                <select name="country" class="select form-control wide" id="country">
                                                    ...
                                                    <option value="{{ $key }}"
                                                        {{ $user->country == $key ? 'selected' : '' }}>{{ $value }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                            ...
                            <div class="row gy-4">
                                        ...
                                        <div class="pb-30">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="current_password" class="form-control"
                                                    id="current_password" placeholder="{{ __('Password') }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="pb-30">
                                        <div class="form-group">
                                            <label for="password"
                                                class="form-label">{{ __('Set a New Password') }}</label>
