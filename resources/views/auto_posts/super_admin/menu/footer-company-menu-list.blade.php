...
@push('title')
{{ __('Footer Left Menus') }}
@endpush
@section('content')
<div class="section-title">
    <h2 class="title">{{ __('Footer Left Menus') }}</h2>
        ...
        <div class="section-wrap">
            <div class="table-waraper">
                ...
                <input type="hidden" id="footer-menu-data-route"
                    value="{{ route('super_admin.setting.menu.footer-left.list') }}">
...
<div class="modal fade" id="addFooterCompanyMenuModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form class="ajax reset" action="{{ route('super_admin.setting.menu.footer-left.store') }}" method="post"
                        ...
                        <div class="row gy-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="footerCompanyMenuName" value="{{ old('name') }}"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link" id="footerCompanyMenuUrl" value="{{ old('link') }}"
                                        placeholder="{{__('e.g. /about')}}" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
