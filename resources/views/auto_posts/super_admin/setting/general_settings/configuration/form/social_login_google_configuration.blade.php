...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0">{{ __('Social Login (Google) Configuration') }}</h4>
    <div class="mClose">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="google_client_id" id="google_client_id"
                           value="{{getOption('google_client_id')}}" class="form-control" placeholder="{{ __('Google Client ID') }}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="google_client_secret" id="google_client_secret"
                           value="{{getOption('google_client_secret')}}" class="form-control" placeholder="{{ __('Google Client Secret') }}">
                </div>
            </div>
            <div class="col-12">
                <div class="alert alert-info">
                    <strong>{{ __('Set callback URL') }}:</strong> {{ url('/auth/google/callback') }}
                </div>
            </div>
        </div>
    </div>
