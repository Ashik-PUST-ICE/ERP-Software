...
<div class="p-30">
    ...
    <div class="section-wrap">
        <div class="table-waraper">
            ...
            <input type="hidden" id="ticketListRoute" value="{{ route('super_admin.ticket.list') }}">
            <input type="hidden" id="assignMemberRoute" value="{{ route('super_admin.ticket.assign-member') }}">
    ...
    <div class="section-wrap">
        <div class="p-30 bg-white bd-one bd-c-stroke bd-ra-10 text-center">
            <h4 class="pb-22 fs-24 fw-500 lh-30 text-center">{{ __('There is no tickets available here!') }}</h4>
...
<div class="modal fade" id="addTicketModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            @include('auto_posts.super_admin.ticket.add-new', ['paymentOrderList' => $paymentOrderList, 'teamMemberList'
            => $teamMemberList])
        </div>
    </div>
</div>
...
@push('script')
<script src="{{ asset('super_admin/js/ticket.js') }}"></script>
@endpush
@endsection