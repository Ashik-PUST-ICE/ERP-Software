        ...
        <ul id="metismenu" class="primary-menu metismenu">
          ...
          <li class="{{ isset($activeRoles) && $activeRoles == 'active' ? 'currrent-menu' : '' }}">
            <a class="has-arrow" href="#role-permission-menu" data-bs-toggle="collapse" role="button"
                aria-expanded="{{ isset($showRolePermission) ? 'true' : 'false' }}"
            ...
            <ul id="role-permission-menu" class="collapse {{ isset($showRolePermission) ? 'show' : '' }}">
              <li><a class="{{ isset($activeRoles) && $activeRoles == 'active' ? 'active' : '' }}" href="{{ route('super_admin.roles.index') }}">{{ __('Roles') }}</a></li>
            </ul>
          </li>

          <li class="divider"><span>{{ __('System Configuration') }}</span></li>
          <li class="{{ (isset($activeApplicationSetting) || isset($activeConfigurationSetting) || isset($activeLandingPageSettings)) ? 'currrent-menu' : '' }}">
            ...
            <ul id="settings-menu" class="collapse {{ isset($showManageApplicationSetting) ? 'show' : '' }}">
              <li><a class="{{ isset($activeApplicationSetting) && $activeApplicationSetting == 'active' ? 'active' : '' }}" href="{{ route('super_admin.setting.application-settings') }}">{{ __('General Setting') }}</a></li>
              <li><a class="{{ isset($activeConfigurationSetting) && $activeConfigurationSetting == 'active' ? 'active' : '' }}" href="{{ route('super_admin.setting.configuration-settings') }}">{{ __('Configuration Settings') }}</a></li>
              <li><a class="{{ isset($activeLandingPageSettings) && $activeLandingPageSettings == 'active' ? 'active' : '' }}" href="{{ route('super_admin.setting.frontend.landing-page.hero') }}">{{ __('Landing Page') }}</a></li>
            </ul>
          </li>
