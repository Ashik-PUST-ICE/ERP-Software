...
<div class="section-title">
    ...
    <button class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
        <i class="fa fa-plus me-2"></i>{{ __('Add Packing Row') }}
    </button>
</div>
        ...
        <div class="section-wrap">
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input class="search-input" id="packingListSearch" placeholder="{{ __('Search order or carton...') }}">
                </div>
                <input type="hidden" id="packing-list-route" value="{{ route('admin.garments.packing-lists.index') }}">
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            @include('admin.garments.packing-lists.form', ['packing' => null, 'orders' => $orders])
        </div>
    </div>
</div>
...
@endsection
@push('script')
<script src="{{ asset('admin/js/garment-packing-lists.js') }}"></script>
@endpush
