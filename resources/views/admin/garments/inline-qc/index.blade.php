        ...
        <div class="section-wrap">
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input class="search-input" id="inlineQcSearch" placeholder="{{ __('Search order, inspection point or inspector...') }}">
                </div>
                <input type="hidden" id="inline-qc-route" value="{{ route('admin.garments.inline-qc.index') }}">
                <table class="display primary-table dataTable dtr-inline" id="garmentInlineQcDataTable">
                    <thead>
                        <tr>
                            <th class="keep-show">{{ __('SL') }}</th>
                            <th>{{ __('Order') }}</th>
                            <th>{{ __('Inspection Point') }}</th>
                            <th>{{ __('Passed / Checked') }}</th>
                            <th>{{ __('Date') }}</th>
                            <th>{{ __('Status') }}</th>
