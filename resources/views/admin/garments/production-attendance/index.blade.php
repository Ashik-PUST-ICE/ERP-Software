...
<div class="section-title">
    ...
    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
        <i class="fa fa-plus me-2"></i>{{ __('Mark Attendance') }}
    </button>
</div>
            ...
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="{{ __('Search Production Attendance...') }}" />
                </div>
                <input type="hidden" id="production-attendance-route" value="{{ route('admin.garments.production-attendance.index') }}">
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            @include('admin.garments.production-attendance.form', ['attendance' => null, 'employees' => $employees, 'orders' => $orders])
        </div>
    </div>
</div>
