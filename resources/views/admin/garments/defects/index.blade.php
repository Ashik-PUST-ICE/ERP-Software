        ...
        <div class="section-wrap">
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input class="search-input" id="defectSearch" placeholder="{{ __('Search order, defect or section...') }}">
                </div>
                <input type="hidden" id="defect-route" value="{{ route('admin.garments.defects.index') }}">
                <table class="display primary-table dataTable dtr-inline" id="garmentDefectDataTable">
                    <thead>
                        <tr>
                            <th class="keep-show">{{ __('SL') }}</th>
                            <th>{{ __('Order') }}</th>
                            <th>{{ __('Defect Type') }}</th>
                            <th>{{ __('Section') }}</th>
                            <th>{{ __('Defect / Rejected') }}</th>
                            <th>{{ __('Date') }}</th>
                            <th>{{ __('Status') }}</th>
...
@endsection
@push('script')
<script src="{{ asset('admin/js/garment-defects.js') }}"></script>
@endpush
