...
<div class="section-title">
    ...
    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
        <i class="fa fa-plus me-2"></i>{{ __('Add Supplier') }}
    </button>
</div>
    ...
    <div class="settings-page-right">
        <div class="section-wrap">
            <div class="table-waraper">
                ...
                <input type="hidden" id="supplier-data-route" value="{{ route('admin.garments.suppliers.index') }}">
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            @include('admin.garments.suppliers.form', ['supplier' => null])
        </div>
    </div>
</div>
...
@push('script')
<script src="{{ asset('admin/js/garment-suppliers.js') }}"></script>
@endpush
