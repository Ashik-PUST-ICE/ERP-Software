...
<div class="section-title">
    ...
    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
        <i class="fa fa-plus me-2"></i>{{ __('Log Communication') }}
    </button>
</div>
        ...
        <div class="section-wrap">
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input type="text" class="search-input" id="searchData" placeholder="{{ __('Search Communications...') }}" />
                </div>
                <input type="hidden" id="merchandiser-communications-data-route" value="{{ route('admin.garments.merchandiser.management.data') }}?section=communications">
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <form class="ajax reset" action="{{ route('admin.garments.merchandiser.communication') }}" method="post"
                data-handler="commonResponseForModal">
                @csrf
                <div class="modal-body zModalTwo-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0">{{ __('Log Communication') }}</h4>
                        <div class="mClose">
                    ...
                    <div class="primary-form">
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{ __('Channel') }} <span class="required">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label">{{ __('Notes') }} <span class="required">*</span></label>
...
@push('script')
<script src="{{ asset('admin/js/garment-merchandiser-communications.js') }}"></script>
@endpush
