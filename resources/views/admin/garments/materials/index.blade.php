...
<div class="section-title">
    ...
    <div class="d-flex align-items-center gap-2">
        <a href="{{ route('admin.garments.materials.scanner') }}" class="primary-btn-outline"><i class="fa-solid fa-barcode me-2"></i>{{ __('Scanner') }}</a>
        <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal"><i class="fa fa-plus me-2"></i>{{ __('Add Material') }}</button>
    </div>
</div>
            ...
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="{{ __('Search materials, barcodes or category...') }}" />
                </div>
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            @include('admin.garments.materials.form', ['material' => null])
        </div>
    </div>
</div>
...
@push('script')
<script src="{{ asset('admin/js/garment-materials.js') }}"></script>
@endpush
