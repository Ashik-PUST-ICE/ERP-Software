    ...
    $(document).ready(function () {
        var table = $('#departmentDataTable').DataTable({
            ...
            drawCallback: function () {
                ...
                var $wrap = $("#department-pagination-wrap");
                if (!$wrap.length) {
                    $('#departmentDataTable').after('<div id="department-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>');
                    $wrap = $("#department-pagination-wrap");
                }
        ...
        $('#searchData').off('keyup.hrmDepartment').on('keyup.hrmDepartment', function () {
