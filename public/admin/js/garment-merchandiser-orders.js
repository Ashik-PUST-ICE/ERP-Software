(function ($) {
    ...
    $(document).ready(function () {
        var table = $('#merchandiserOrderDataTable').DataTable({
            ...
            stateSave: false,
            ajax: {
                url: $('#merchandiser-orders-data-route').val()
            },
            dom: 't',
            columnDefs: [
                {
            ...
            columns: [
                ...
                { data: 'style', name: 'style', searchable: false, orderable: false },
                { data: 'primary', name: 'primary', searchable: false, orderable: false },
                { data: 'team', name: 'team', searchable: false, orderable: false },
            ...
            drawCallback: function () {
                ...
                var $wrap = $("#order-pagination-wrap");
                if (!$wrap.length) {
                    $('#merchandiserOrderDataTable').after('<div id="order-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>');
                    $wrap = $("#order-pagination-wrap");
                }
