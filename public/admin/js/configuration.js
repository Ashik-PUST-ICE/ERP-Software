(function ($) {
    ...
    window.configureModal = function (selector) {
        $.ajax({
            ...
            success: function (data) {
                var modalContent = '<div class="modal-body zModalTwo-body">' + data + '</div>';
                $(document).find('#configureModal').find('.modal-content').html(modalContent);
    ...
    window.helpModal = function (selector) {
        $.ajax({
            ...
            success: function (data) {
                var modalContent = '<div class="modal-body zModalTwo-body">' + data + '</div>';
                $(document).find('#helpModal').find('.modal-content').html(modalContent);
