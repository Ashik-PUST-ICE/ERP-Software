(function ($) {
    ...
    $(document).ready(function () {
        var table = $('#merchandiserCommunicationDataTable').DataTable({
            pageLength: 10,
            ordering: false,
            serverSide: true,
            processing: true,
            ...
            stateSave: false,
            ajax: {
                url: $('#merchandiser-communications-data-route').val()
            },
            dom: 't',
            columnDefs: [
                {
            ...
            columns: [
                ...
                { data: 'channel', name: 'channel', searchable: false },
            ...
            drawCallback: function () {
                ...
                var $wrap = $("#communication-pagination-wrap");
                if (!$wrap.length) {
                    $('#merchandiserCommunicationDataTable').after('<div id="communication-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>');
                    $wrap = $("#communication-pagination-wrap");
                }
