(function ($) {
    ...
    $(document).ready(function () {
        var table = $('#leaveDataTable').DataTable({
            ...
            drawCallback: function () {
                ...
                if (!$wrap.length) {
                    $('#leaveDataTable').after('<div id="leave-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>');
        ...
        $('#searchData').off('keyup.hrmLeave').on('keyup.hrmLeave', function () {
    ...
    window.rejectLeave = function (url) {
