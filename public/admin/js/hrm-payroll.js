(function ($) {
    ...
    $(document).ready(function () {
        var table = $('#payrollDataTable').DataTable({
            pageLength: 10,
            ordering: false,
            serverSide: true,
            processing: true,
            ...
            ajax: {
                ...
                type: 'GET',
                data: function (d) {
                    d.month = $('#filterMonth').val() || $('input[name="month"]').val();
                }
            },
            dom: 't',
            columnDefs: [
            ...
            columns: [
                ...
                { data: 'basic_salary', name: 'basic_salary', searchable: false },
                { data: 'allowances', name: 'allowances', searchable: false },
                { data: 'deductions', name: 'deductions', searchable: false },
            ...
            drawCallback: function () {
                ...
                if (!$wrap.length) {
                    $('#payrollDataTable').after('<div id="payroll-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>');
        ...
        $('#searchData').off('keyup.hrmPayroll').on('keyup.hrmPayroll', function () {
