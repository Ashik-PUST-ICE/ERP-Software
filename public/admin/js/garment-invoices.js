(function ($) {
    ...
    $(document).ready(function () {
        var table = $('#garmentInvoiceDataTable').DataTable({
            pageLength: 10,
            ordering: false,
            serverSide: true,
            processing: true,
            ...
            stateSave: false,
            dom: 't',
            ajax: { url: $('#garment-invoice-data-route').val() },
            ...
            columns: [
                ...
                { data: 'paid_display', name: 'paid_amount', searchable: false },
            ...
            drawCallback: function () {
                ...
                var $wrap = $('#garment-invoice-pagination-wrap');

                if (!$wrap.length) {
                    $('#garmentInvoiceDataTable').after('<div id="garment-invoice-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>');
                    $wrap = $('#garment-invoice-pagination-wrap');
                }
        ...
        $('#searchData').off('keyup.garmentInvoice').on('keyup.garmentInvoice', function () {
