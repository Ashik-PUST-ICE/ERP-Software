(function ($) {
    ...
    $(document).ready(function () {
        var table = $('#garmentPlanDataTable').DataTable({
        ...
        $('#planSearchData').off('keyup.garmentPlan').on('keyup.garmentPlan', function () { table.search(this.value).draw(); });
    });
})(jQuery);
