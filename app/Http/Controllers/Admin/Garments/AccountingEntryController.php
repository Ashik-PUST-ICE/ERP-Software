...
class AccountingEntryController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $orders = GarmentOrder::latest()->get();
        return view('admin.garments.accounting.form', compact('entry', 'orders'));
    }

    public function update(AccountingEntryRequest $request, $id)
    {
        $request->merge(['id' => $id]);
        return $this->entryService->store($request);
    }
