...
use App\Http\Requests\SuperAdmin\LanguageRequest;
...
class LanguageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['subLanguageSettingActiveClass'] = 'active';
        
        $perPage = 7;
        $page = $request->get('page', 1);
        $languages = Language::orderBy('id', 'DESC')->get();
        $total = $languages->count();
        $languages = $languages->slice(($page - 1) * $perPage, $perPage);
        ...
        return view('auto_posts.super_admin.setting.languages.index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return $this->success([
            'language' => $language,
            'flag_url' => getFileUrl($language->flag_id),
    ...
    public function translateLanguage($id)
    {
        ...
        // Set the application locale to this language
        app()->setLocale($iso_code);
        session()->put('local', $iso_code);
        ...
        if (request()->ajax()) {
            return view('auto_posts.super_admin.setting.languages.partials.translations_table', compact(
                'translators',
                'language',
                'total',
                'perPage',
        ...
        return view('auto_posts.super_admin.setting.languages.translate', array_merge($data, compact(
            'translators',
            'language',
            'total',
            'perPage',
