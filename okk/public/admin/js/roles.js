    ...
    $(document).ready(function () {
        var table = $('#rolesDataTable').DataTable({
            ...
            drawCallback: function () {
                ...
                if (!$wrap.length) {
                    $('#rolesDataTable').after('<div id="roles-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>');
                    $wrap = $("#roles-pagination-wrap");
                }
        ...
        $('#searchData').off('keyup.adminRoles').on('keyup.adminRoles', function () {
