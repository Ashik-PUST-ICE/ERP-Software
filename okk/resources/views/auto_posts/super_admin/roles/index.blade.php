...
<div class="settings-page-area">
    ...
    <div class="settings-page-right">
        <div class="section-wrap">
            ...
            <div class="table-waraper">
                <div class="search-input-wrap">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="{{ __('Search By Role...') }}" />
                </div>
                <input type="hidden" id="roles-data-route" value="{{ route('super_admin.roles.index') }}">
            ...
            {{-- Global pagination design (filled by JS for server-side DataTables) --}}
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <form class="ajax reset" action="{{ route('super_admin.roles.store') }}" method="post"
                data-handler="commonResponseWithPageLoad">
                @csrf
                <div class="modal-body zModalTwo-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0">{{__('Add New Role')}}</h4>
                        <div class="mClose">
                        ...
                        <div class="row gy-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="name" class="form-label">{{ __('Role Name') }}<span
...
<script src="{{ asset('super_admin/js/roles.js') }}"></script>
@endpush