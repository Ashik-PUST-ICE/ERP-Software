        ...
        <div class="col-12">
            ...
            <div class="row gy-4">
                    ...
                    <div class="section-wrap my-plan-area h-100">
                        ...
                        <div class="plan-footer"
                            ...
                            <div class="btn-list" style="display: flex; gap: 10px;">
                                <a href="{{ route('super_admin.ticket.edit', encrypt($ticketDetails->id)) }}"
                                ...
                                <button type="button" class="primary-btn btn-outline ticket-delete-btn"
                                    data-route="{{ route('super_admin.ticket.delete', encrypt($ticketDetails->id)) }}"
                                    data-redirect="{{ route('super_admin.ticket.list') }}"
                ...
                <div class="col-lg-8">
                    ...
                    @include('auto_posts.super_admin.ticket.conversation')
                </div>
            </div>
        </div>
        @else
