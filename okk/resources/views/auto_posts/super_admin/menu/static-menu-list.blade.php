...
<div class="section-title">
    <h2 class="title">{{ __('Static Menus') }}</h2>
    ...
    <div class="settings-page-right">
        <div class="section-wrap">
            <div class="table-waraper">
                ...
                <input type="hidden" id="menu-data-route" value="{{ route('super_admin.setting.menu.static.list') }}">
...
<div class="modal fade" id="addStaticMenuModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form class="ajax reset" action="{{ route('super_admin.setting.menu.static.store') }}" method="post"
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link" id="menuUrl" value="{{ old('link') }}"
                                        placeholder="{{__('e.g. /contact')}}" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
