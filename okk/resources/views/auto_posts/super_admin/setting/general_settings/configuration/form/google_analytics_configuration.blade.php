...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0">{{__('Google Analytics Configuration')}}</h4>
    <div class="mClose">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="google_analytics_tracking_id"
                           value="{{getOption('google_analytics_tracking_id')}}" class="form-control" placeholder="{{ __('Google Analytics Tracking Id') }}">
                </div>
            </div>
        </div>
    </div>
