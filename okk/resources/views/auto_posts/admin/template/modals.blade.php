                ...
                <div id="ai-preview-section" class="ai-preview-section mt-4" style="display: none;">
                    ...
                    <div class="preview-content">
                        ...
                        <div id="ai-image-preview" class="ai-preview-item" style="display: none;">
                            ...
                            <div class="preview-actions d-flex gap-2">
                                <button type="button" class="primary-btn btn-sm" id="save-image-to-gallery-btn">Save to
                                    Gallery</button>
                                <button type="button" class="primary-btn btn-outline-secondary btn-sm"
                        ...
                        <div id="ai-video-preview" class="ai-preview-item" style="display: none;">
                            ...
                            <div class="preview-actions d-flex gap-2">
                                <button type="button" class="primary-btn btn-sm" id="save-video-to-gallery-btn">Save to
                                    Gallery</button>
                                <button type="button" class="primary-btn btn-outline-secondary btn-sm"
...
<!-- UploadMediaModal -->
<div class="modal fade primary-modal" id="UploadMediaModal" tabindex="-1" aria-labelledby="UploadMediaModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="UploadMediaModalLabel">Upload Media</h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="primary-form">
                    <form action="#">
                        <div class="row gy-4">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="mediaUpload" class="form-label">Select Media</label>
                                    <input type="file" class="form-control" id="mediaUpload" name="media"
                                        accept="image/*,video/*">
                                </div>
                            </div>
                        </div>
