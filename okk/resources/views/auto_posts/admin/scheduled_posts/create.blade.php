...
<div class="section-title">
    <h2 class="title">{{ __('Create Post') }}</h2>
</div>


<form action="{{ route('admin.all-posts.store') }}" method="POST" id="scheduledPostForm" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="publish_now" value="1" id="publish_now_field">
    <input type="hidden" name="scheduled_time" id="scheduled_time_field" value="">
    <input type="hidden" name="gallery_image_ids" id="selected_gallery_image_ids" value="">
    <input type="hidden" name="gallery_video_ids" id="selected_gallery_video_ids" value="">
    ...
    <div class="create-post-wrap">
                    ...
                    <li>
                        <label class="platform-name{{ !$isAllowed ? ' disabled' : '' }}">
                            ...
                            <span class="post-paltform"><span class="icon">
                                    @switch($platform)
                                    @case('Facebook') <i class="fa-brands fa-facebook-f"></i>
                                    @break
                                    @case('LinkedIn')
        ...
        <div class=" create-post-center">
            <div class="post-center-top">
                <ul class="nav nav-tabs post-tabs" id="Post" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="Feed-tab" data-bs-toggle="tab"
                            data-bs-target="#Feed-tab-pane" type="button" role="tab" aria-controls="Feed-tab-pane"
                            aria-selected="true">Feed</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="Reels-tab" data-bs-toggle="tab" data-bs-target="#Reels-tab-pane"
                            type="button" role="tab" aria-controls="Reels-tab-pane" aria-selected="false">Reels</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="Story-tab" data-bs-toggle="tab" data-bs-target="#Story-tab-pane"
                            type="button" role="tab" aria-controls="Story-tab-pane" aria-selected="false">Story</button>
                    </li>
                </ul>
                <div class="post-content">
                    ...
                    <textarea class="post-content-box" name="content" id="content"
                        placeholder="Start from here...">{{ old('content') }}</textarea>
                </div>
            </div>
            <input type="hidden" name="post_type" id="post_type" value="{{ old('post_type', 'Feed') }}">
            <div class="post-center-footer">
                        ...
                        <ul class="post-actions">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu media-dropdown">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#" data-bs-toggle="offcanvas"
                                            data-bs-target="#SelectTemplateOffcanvas">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M6 3H3C2.17157 3 1.5 3.67157 1.5 4.5V15C1.5 15.8284 2.17157 16.5 3 16.5H13.5C14.3284 16.5 15 15.8284 15 15V12"
                                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                                <path d="M11.25 1.5H15.75C16.1642 1.5 16.5 1.83579 16.5 2.25V6.75"
                                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                                <path d="M10.5 7.5L16.5 1.5" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" />
                                                <path d="M12.75 1.5H16.5V5.25" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" />
                                            </svg>
                                            Use Template
                                        </a>
                            ...
                            <li class="schedule-wrapper" style="position: relative;">
                                <a href="javascript:void(0)" class="datepick" id="datePickerTrigger">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div id="custom-picker-box" class="picker-card shadow-sm" style="display:none;">
                                    <div id="inline-calendar"></div>
                                    <div class="time-section">
                                        <label>Time</label>
                                        <div class="time-input-wrapper">
                                            <input type="time" id="custom-time" value="">
                                        </div>
                                    </div>
                                    <div class="picker-footer">
                                        <div class="scheduled-info">
                                            <p>Scheduled for: <strong id="display-date">Select a
                                                    date</strong></p>
                                            <p class="small text-muted mb-0 mt-1">{{ __('Times are in :timezone', ['timezone' => getAppTimeZone()]) }}</p>
                                        </div>
                                        <div class="btn-group gap-2">
                                            <button class="primary-btn btn-secondary" id="closePicker">Cancel</button>
                                            <button class="primary-btn" id="confirm-schedule">Schedule</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="post-footer-right">
                        <div class="btn-list mt-0">
                            <a href="javascript:void(0)" id="aiAssistantBtn" class="primary-btn btn-outline-secondary">
                                ...
                                AI Assistant</a>
                            <button type="submit" class="primary-btn">Post <svg width="15" height="15"
                ...
                <div class="save-template-area">
                    <div class="form-check-area">
                        <input type="checkbox" class="form-check-input" id="saveTemplateCheckbox" name="save_template">
                        <label class="form-check-label" for="saveTemplateCheckbox">Save This
                            Template</label>
                    </div>
                    <!-- <a href="#" class="primary-btn btn-secondary" data-bs-toggle="modal"
                        data-bs-target="#TemplateSaveModal">Save Draft</a> -->
                </div>
            </div>
        </div>
                ...
                <div class="tab-pane fade show active" id="Feed-tab-pane" role="tabpanel" aria-labelledby="Feed-tab"
                    ...
                    <div class="feed-wrap">
                        ...
                        <div class="feed-middle">
                            <p class="template-preview-content">What's in your mind</p>
                        </div>
                ...
                <div class="tab-pane fade" id="Reels-tab-pane" role="tabpanel" aria-labelledby="Reels-tab" tabindex="0">
                    <div class="reels-area">
                        ...
                        <div class="reels-footer"
                            style="padding: 8px 8px 0 8px; border-top: 1px solid rgba(255,255,255,0.2); margin-top: 8px;">
                ...
                <div class="tab-pane fade" id="Video-tab-pane" role="tabpanel" aria-labelledby="Video-tab" tabindex="0">
                    <div class="reels-area">
                        <div class="author-area">
                            <span class="icon"><svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <rect width="19" height="19" rx="5.75758" fill="#FF0000" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M7.5 6.5V12.5L12.5 9.5L7.5 6.5Z"
                ...
                <div class="tab-pane fade" id="Story-tab-pane" role="tabpanel" aria-labelledby="Story-tab" tabindex="0">
                    <div class="reels-area story-area">
                        ...
                        <div class="story-content-center"
                            style="display: flex; align-items: center; justify-content: center; min-height: 80px; padding: 12px; text-align: center;">
                            <p class="template-preview-content mb-0"
                                style="padding: 8px 8px 0 8px; font-size: 14px; color: #fff; line-height: 1.4; text-shadow: 0 1px 2px rgba(0,0,0,0.5);">
                            </p>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="TemplateSaveModalLabel">Save Template</h2>
                    ...
                    <div class="row gy-4">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="template_title" class="form-label">Template Name<span
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="template_status_select" class="form-label">Status<span
                                        class="required">*</span></label>
                                <select class="select form-control wide" id="template_status_select"
                                    name="template_status_select" required>
                                    <option value="active">Active</option>
                                    <option value="inactive">Inactive</option>
                                </select>
                            </div>
                        </div>
                        <input type="hidden" name="platform" id="selected_platforms" value="">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="primary-btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="primary-btn" id="saveTemplateBtn"
                    data-url="{{ route('admin.template.store') }}">Save Template</button>
            </div>
        </div>
    </div>
</div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="GalleryModal" aria-labelledby="GalleryModalLabel">
    ...
    <div class="offcanvas-footer" style="padding: 15px; border-top: 1px solid #dee2e6; background: #fff;">
        <button type="button" class="primary-btn w-100" id="applyGallerySelection">
            Apply <span class="badge bg-light text-dark ms-2" id="selectionCount" style="display: none;">0</span>
        </button>
    </div>
</div>

<!-- SelectTemplateOffcanvas - Right side offcanvas like GalleryModal -->
<div class="offcanvas offcanvas-end" tabindex="-1" id="SelectTemplateOffcanvas"
    aria-labelledby="SelectTemplateOffcanvasLabel">
    <div class="offcanvas-header">
        <h2 class="offcanvas-title" id="SelectTemplateOffcanvasLabel">Select Template</h2>
        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body primary-form">
        <!-- Search -->
        <div class="search-input-wrap mb-4">
            <label class="icon" for="templateSearch">
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.625 10.625L11.6875 11.6875" stroke="#6E5858" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path
        ...
        <!-- Platform Filter -->
        <div class="form-group mb-4">
            <select class="select form-control wide" id="templatePlatformFilter">
        ...
        <div id="templateListContainer" class="row gy-3">
            <div class="col-12 text-center">
...
@include('auto_posts.admin.scheduled_posts.modals')

<div id="post-config" data-template-list-url="{{ $templateListUrl }}" data-hashtags-url="{{ $hashtagsIndexUrl }}"
    data-platform-key-map='@json($platformKeyToName)'
    ...
    data-allowed-providers='@json($allowedProviders ?? [])' data-post-limit='{{ $postLimitInfo["limit"] ?? "null" }}'
    data-post-used='{{ $postLimitInfo["used"] ?? 0 }}'
...
<script src="{{ asset('admin/js/create-post.js') }}?v={{ time() }}"></script>
<script type="module" src="{{ asset('admin/js/emoji-picker.js') }}"></script>
@endpush