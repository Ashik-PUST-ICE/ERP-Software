...
@push('title')
{{ __('AI Generated Content List') }}
@endpush

@section('content')
<div class="content-wrapper">
    <div class="section-title">
        <h2 class="title">{{ __('AI Generated Content') }}</h2>
        <a href="{{ route('admin.ai.generate-content') }}" class="primary-btn">+ {{ __('Generate New') }}</a>
    </div>
    <div class="section-wrap">
        <div class="table-waraper">
            <div class="search-input-wrap">
                ...
                <input type="text" class="search-input" id="searchData" placeholder="{{ __('Search by prompt...') }}" />
            </div>
            <table class="display ai-data-table primary-table" id="aiGeneratedTable"
                data-url="{{ route('admin.ai.generated-content.datatable') }}">
                <thead>
                    <tr>
                        <th class="keep-show">#SL</th>
                        <th class="keep-show">{{ __('Prompt') }}</th>
                        <th class="keep-show">{{ __('Type') }}</th>
                        <th class="keep-show">{{ __('Generated Text') }}</th>
                        <th class="keep-show">{{ __('Model') }}</th>
...
@push('script')
<script src="{{ asset('admin/js/ai-generated-content.js') }}"></script>
@endpush