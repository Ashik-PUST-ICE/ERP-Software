        ...
        <form action="{{ route('ZaiInstaller::final') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="AppName" name="app_name"
                                value="{{ $_ENV['APP_NAME'] }}" placeholder="{{ __('ZaiInstaller') }}" />
                        </div>
                    </div>
                    <div class="col-md-6 d-none">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="AppURL" name="app_url"
                                value="{{ explode('/', (preg_replace('#^www\.#', '', preg_replace('#^https?://#', '', request()->url()))))[0] }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                value="{{ old('email', 'install@zainiklab.com') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="purchase_code" name="purchase_code"
                                value="{{ old('purchase_code', '1234567890') }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="DatabaseHost" name="db_host"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="DatabaseUser" name="db_user"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="DatabaseName" name="db_name"
                                value="{{ $_ENV['DB_DATABASE'] }}" placeholder="{{ __('Type your database name') }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="MailHost" name="mail_host"
                                value="{{ $_ENV['MAIL_HOST'] }}" placeholder="{{ __('Type Your mail host name') }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="MailPort" name="mail_port"
                                value="{{ $_ENV['MAIL_PORT'] }}" placeholder="{{ __('Type your mail port') }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="MailUsername" name="mail_username"
                                ...
                                placeholder="{{ __('Type your mail username') }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="MailPassword" name="mail_password"
                                value="{{ $_ENV['MAIL_PASSWORD'] }}" placeholder="password" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="single-section d-none">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="purchasecode" name="purchasecode"
                        value="NHLE-L6MI-4GE4-ETEV" placeholder="NHLE-L6MI-4GE4-ETEV" />
                </div>
            </div>
            <div class="row">
                <div class="col-6">
