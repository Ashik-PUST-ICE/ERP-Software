                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <form class="ajax primary-form" method="POST" enctype="multipart/form-data"
                            ...
                            action="<?php echo e(route('super_admin.profile.update')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row gy-4">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="pb-40">
                                        <div class="upload-img-box profileImage-upload"
                                            ...
                                            <div class="icon"><img src="<?php echo e(asset('assets/images/icon/edit-2.svg')); ?>"
                                                    alt="" />
                                            </div>
...
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\setting\profile\index.blade.php ENDPATH**/ ?>