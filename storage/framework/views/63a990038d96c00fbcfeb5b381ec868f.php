    ...
    <div class="row gy-4">
        ...
        <div class="col-12">
            <div class="section-title">
                ...
                <a href="<?php echo e(route('super_admin.ticket.list')); ?>"
            ...
            <div class="row gy-4">
                    ...
                    <div class="section-wrap my-plan-area h-100">
                        ...
                        <div class="plan-footer"
                            ...
                            <div class="btn-list" style="display: flex; gap: 10px;">
                                <a href="<?php echo e(route('super_admin.ticket.edit', encrypt($ticketDetails->id))); ?>"
                                ...
                                <button type="button" class="primary-btn btn-outline ticket-delete-btn"
                                    data-route="<?php echo e(route('super_admin.ticket.delete', encrypt($ticketDetails->id))); ?>"
                                    data-redirect="<?php echo e(route('super_admin.ticket.list')); ?>"
                ...
                <div class="col-lg-8">
                    ...
                    <?php echo $__env->make('auto_posts.super_admin.ticket.conversation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
        <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\ticket\details.blade.php ENDPATH**/ ?>