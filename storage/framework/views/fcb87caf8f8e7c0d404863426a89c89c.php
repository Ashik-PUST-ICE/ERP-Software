...
<nav class="primry-tabs mb-20">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <button class="nav-link active" id="nav-AllPlatforms-tab" data-bs-toggle="tab"
            ...
            aria-selected="true"><?php echo e(__('All Platforms')); ?></button>

        <?php $__currentLoopData = $tabPlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button class="nav-link" id="nav-<?php echo e(ucfirst($pl)); ?>-tab" data-bs-toggle="tab"
            data-bs-target="#nav-<?php echo e(ucfirst($pl)); ?>" type="button" role="tab" aria-controls="nav-<?php echo e(ucfirst($pl)); ?>"
            aria-selected="false">
            <?php echo $platformIcons[$pl] ?? ''; ?>

            <?php echo e(ucfirst($pl)); ?>
...
<div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane fade show active" id="nav-AllPlatforms" role="tabpanel" aria-labelledby="nav-AllPlatforms-tab"
        tabindex="0">
        <?php echo $__env->make('auto_posts.admin.partials.dashboard-stat-cards', [
    ...
    <?php $__currentLoopData = $tabPlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="tab-pane fade" id="nav-<?php echo e(ucfirst($pl)); ?>" role="tabpanel" aria-labelledby="nav-<?php echo e(ucfirst($pl)); ?>-tab"
        tabindex="0">
        <?php echo $__env->make('auto_posts.admin.partials.dashboard-stat-cards', [
    ...
    <div class="col-xl-6 col-lg-6">
        <div class="section-wrap social-accounts-chart h-100">
            <div class="section-small-title mb-0">
                <h3 class="title"><?php echo e(__('Social Accounts')); ?></h3>
            </div>
            ...
            <div class="stats">
                <div class="stat-box">
                    <strong><?php echo e($totalAccounts); ?></strong>
                    <?php echo e(__('Total')); ?>

                </div>
                <div class="stat-box">
                    <strong><?php echo e($activeAccounts); ?></strong>
                    <?php echo e(__('Active')); ?>

                </div>
                <div class="stat-box">
                    <strong><?php echo e($totalAccounts - $activeAccounts); ?></strong>
    ...
    <div class="col-xl-6 col-lg-6">
        <div class="section-wrap h-100">
            <div class="section-small-title">
                <h3 class="title"><?php echo e(__('Latest Post')); ?></h3>
            </div>
            <table id="latestPostsTable" data-url="<?php echo e(route('admin.dashboard.latest-posts')); ?>"
                class="display primary-table w-100">
                <thead>
                    <tr>
                        <th class="keep-show">#SL</th>
                        <th><?php echo e(__('Platform Name')); ?></th>
...
<input type="hidden" id="transaction-route" value="<?php echo e(route('admin.dashboard')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startPush('script'); ?>
<!-- <script src="<?php echo e(asset('common/js/apexcharts.min.js')); ?>"></script> -->
<script src="<?php echo e(asset('admin/js/admin-dashboard.js')); ?>?ver=<?php echo e(env('VERSION', 0)); ?>"></script>
<script>
(function() {
    var labels = <?php echo json_encode($chartLabels, 15, 512) ?>;
    var series = <?php echo json_encode($chartSeries, 15, 512) ?>;
    var totalAccounts = <?php echo e((int) $totalAccounts); ?>;
    <?php
    $orderedColors = [];
    ...
    ?>
    var colors = <?php echo json_encode($orderedColors, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\dashboard.blade.php ENDPATH**/ ?>