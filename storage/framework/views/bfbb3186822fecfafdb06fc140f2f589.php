...
<div class="auth-area">
    <div class="auth-left">
        <div class="auth-form-wrap">
            ...
            <div class="auth-top">
                <h2><?php echo e(__('Confirm Email')); ?></h2>
                <h3><?php echo e(__('Please check your email')); ?> <span><?php echo e($user->email); ?></span>
                    <?php echo e(__('and enter the otp below to verify')); ?></h3>
            </div>
            <form action="<?php echo e(route('email.verified', $token)); ?>" method="POST" class="otp-form" name="otp-form">
                <?php echo csrf_field(); ?>
                <div class="auth-form">
                    ...
                    <button id="verify-btn" type="submit" class="auth-form-btn"><?php echo e(__('Verify')); ?></button>
                </div>
            </form>
            <form method="POST" action="<?php echo e(route('email.verify.resend', $token)); ?>" class="d-none" id="resent-form">
                <?php echo csrf_field(); ?>
            </form>
        </div>
    </div>
...
var countDownDate = new Date('<?php echo e($user->otp_expiry); ?>').getTime();
...
@endpush
<?php echo $__env->make('auth.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auth\verify.blade.php ENDPATH**/ ?>