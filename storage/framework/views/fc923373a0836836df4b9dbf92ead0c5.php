...
<?php echo e(__('Footer Right Menus')); ?>

<?php $__env->stopPush(); ?>
<?php $__env->startSection('content'); ?>
<div class="section-title">
    <h2 class="title"><?php echo e(__('Footer Right Menus')); ?></h2>
        ...
        <div class="section-wrap">
            <div class="table-waraper">
                ...
                <input type="hidden" id="footer-menu-data-route"
                    value="<?php echo e(route('super_admin.setting.menu.footer-right.list')); ?>">
...
<div class="modal fade" id="addFooterSupportMenuModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form class="ajax reset" action="<?php echo e(route('super_admin.setting.menu.footer-right.store')); ?>" method="post"
                        ...
                        <div class="row gy-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="footerSupportMenuName" value="<?php echo e(old('name')); ?>"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link" id="footerSupportMenuUrl" value="<?php echo e(old('link')); ?>"
                                        placeholder="<?php echo e(__('e.g. /support')); ?>" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
...
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\menu\footer-support-menu-list.blade.php ENDPATH**/ ?>