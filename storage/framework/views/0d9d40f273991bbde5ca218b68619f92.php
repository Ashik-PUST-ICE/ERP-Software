...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row gy-4 mb-4 super-admin-dashboard-kpis">
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 sa-customer">
            <div class="card-box">
                ...
                <div class="card-info">
                    <h2><?php echo e(number_format($totalCustomers)); ?></h2>
                    <h3><?php echo e(__('Total Customer')); ?></h3>
                </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 sa-packages">
            <div class="card-box">
                ...
                <div class="card-info">
                    <h2><?php echo e(number_format($activePackages)); ?></h2>
                    <h3><?php echo e(__('Active Package')); ?></h3>
                </div>
                <span class="card-status up">
                    <?php echo e(number_format($activePackages)); ?>
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 sa-subscriptions">
            <div class="card-box">
                ...
                <div class="card-info">
                    <h2><?php echo e(number_format($currentSubscriptions)); ?></h2>
                    <h3><?php echo e(__('Current Subscriptions')); ?></h3>
                </div>
                <span class="card-status <?php echo e($currentSubscriptions > 0 ? 'up' : 'down'); ?>">
                    <?php echo e(number_format($currentSubscriptions)); ?>

                    <span class="arrow"><i class="fa-solid fa-arrow-<?php echo e($currentSubscriptions > 0 ? 'up' : 'down'); ?>"></i></span>
                </span>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 sa-earnings">
            <div class="card-box">
                ...
                <div class="card-info">
                    <h2><?php echo e(showPrice($totalEarn)); ?></h2>
                    <h3><?php echo e(__('Total Earn')); ?></h3>
                </div>
                <span class="card-status up">
                    <?php echo e(showPrice($totalEarn)); ?>
    ...
    <div class="row gy-4">
        <div class="col-xl-6">
            <div class="section-wrap h-100">
                <div class="section-small-title mb-0">
                    <h3 class="title"><?php echo e(__('Monthly Subscription Summary')); ?></h3>
                </div>
        ...
        <div class="col-xl-6">
            <div class="section-wrap h-100">
                <div class="section-small-title mb-0">
                    <h3 class="title"><?php echo e(__('Monthly Sell Summary')); ?></h3>
                </div>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        (function () {
            const subscriptionData = <?php echo json_encode($subscriptionChart, 15, 512) ?>;
...
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\dashboard.blade.php ENDPATH**/ ?>