<header class="header-area">
        <div class="header-left">
          ...
          <h3 class="bredcumbs-page d-none d-sm-block"><?php echo e(__('Home')); ?> / <?php echo e(__('Settings')); ?> / <?php echo e(__('App Settings')); ?></h3>
        </div>
        <div class="header-right">
          <div class="dropdown profile-dropdown">
            <button class="profile-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              <div class="profile-avatar">
                <img src="<?php echo e(asset(getFileUrl(auth()->user()->image))); ?>" alt="<?php echo e(auth()->user()->name); ?>">
              </div>
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="<?php echo e(auth()->user()->role == USER_ROLE_SUPER_ADMIN ? route('super_admin.profile.index') : route('admin.profile.index')); ?>">
      ...
      <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none">
          <?php echo csrf_field(); ?>
      </form><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\user\layouts\nav.blade.php ENDPATH**/ ?>