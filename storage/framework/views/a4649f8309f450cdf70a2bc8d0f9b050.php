    ...
    <div class="settings-page-right">
        <div class="section-wrap">
            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                ...
                <ul class="nav post-tabs profile-setting-tab-button" id="pills-tab" role="tablist">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <form class="ajax primary-form" method="POST" enctype="multipart/form-data"
                            data-handler="commonResponseWithPageLoad" autocomplete="off"
                            ...
                            <div class="row gy-4">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="pb-40">
                                        <div class="upload-img-box profileImage-upload"
                                            ...
                                            <div class="icon">
                                                <img src="<?php echo e(asset('assets/images/icon/edit-2.svg')); ?>" alt="" />
                                            </div>
                                        ...
                                        <h4 class="fs-18 fw-500 lh-22 text-1b1c17 pb-20 mt-3"><?php echo e(__('Personal Info')); ?>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="pb-30">
                                        <div class="form-group">
                                            <label for="epFullName" class="form-label"><?php echo e(__('Full Name')); ?><span
                                                    class="required">*</span></label>
                                            <input type="text" class="form-control" id="epFullName"
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="pb-30">
                                        <div class="form-group">
                                            <label for="epEmail" class="form-label"><?php echo e(__('Email')); ?><span
                                                    class="required">*</span></label>
                                            <input type="email" class="form-control" id="epEmail"
                                                value="<?php echo e($user->email); ?>" name="email" placeholder="<?php echo e(__('Email')); ?>"
                                                required />
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="pb-30">
                                            <div class="form-group">
                                                <label for="phoneNumber"
                                                    class="form-label"><?php echo e(__('Phone Number')); ?><span
                                                        class="required">*</span></label>
                                                <input type="number" class="form-control" id="phoneNumber"
                                                    value="<?php echo e($user->mobile); ?>" name="mobile"
                                    ...
                                    <div>
                                        <div class="pb-30">
                                            <div class="form-group">
                                                ...
                                                <select name="country" class="select form-control wide" id="country">
                                                    ...
                                                    <option value="<?php echo e($key); ?>"
                                                        <?php echo e($user->country == $key ? 'selected' : ''); ?>><?php echo e($value); ?>
                            ...
                            <div class="btn-list">
                                <button type="submit" class="primary-btn"><?php echo e(__('Save Changes')); ?></button>
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                        ...
                        <form class="ajax primary-form" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div>
                                        <!-- <h4 class="fs-20 fw-bold lh-24 text-1b1c17 pb-20">
                                        ...
                                        <div class="pb-30">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="current_password" class="form-control"
                                                    id="current_password" placeholder="<?php echo e(__('Password')); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="pb-30">
                                        <div class="form-group">
                                            <label for="password"
                                                class="form-label"><?php echo e(__('Set a New Password')); ?></label>
...
<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\profile\index.blade.php ENDPATH**/ ?>