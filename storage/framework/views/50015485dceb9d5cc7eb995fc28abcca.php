<div class="row gy-4">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="card-box">
            ...
            <div class="card-info">
                <h2><?php echo e(number_format($postCount)); ?></h2>
                <h3><?php echo e(__('Total Posts (last 30 days)')); ?></h3>
            </div>
            <span class="card-status up">
                <?php echo e($postCount > 0 ? '+' . $postCount : '0'); ?>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="card-box">
            ...
            <div class="card-info">
                <h2><?php echo e(isset($accountStats[$platform]) ? number_format($accountStats[$platform]->total) : number_format($totalAccounts)); ?></h2>
                <h3><?php echo e(__('Connected Accounts')); ?></h3>
            </div>
            <span class="card-status up">
                <?php echo e(isset($accountStats[$platform]) ? $accountStats[$platform]->total : $totalAccounts); ?>
            ...
            <div class="card-info">
                <?php
                    $activeCount = isset($accountStats[$platform])
                        ...
                        : $activeAccounts;
                ?>
                <h2><?php echo e(number_format($activeCount)); ?></h2>
                <h3><?php echo e(__('Active Accounts')); ?></h3>
            </div>
            <span class="card-status <?php echo e($activeCount > 0 ? 'up' : 'down'); ?>">
                <?php echo e($activeCount); ?>

                <span class="arrow"><i class="fa-solid fa-arrow-<?php echo e($activeCount > 0 ? 'up' : 'down'); ?>"></i></span>
            </span>
        </div>
    </div>
        ...
        <div class="card-box">
            ...
            <div class="card-info">
                <?php
                    $pendingCount = 0;
                ?>
                <h2><?php echo e(number_format($pendingCount)); ?></h2>
                <h3><?php echo e(__('Scheduled Posts')); ?></h3>
            </div>
            <span class="card-status up">
...
<?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\partials\dashboard-stat-cards.blade.php ENDPATH**/ ?>