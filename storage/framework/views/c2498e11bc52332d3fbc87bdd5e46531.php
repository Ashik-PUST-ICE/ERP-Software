...
<div class="p-30">
    ...
    <div class="section-wrap">
        <div class="table-waraper">
            ...
            <input type="hidden" id="ticketListRoute" value="<?php echo e(route('super_admin.ticket.list')); ?>">
            <input type="hidden" id="assignMemberRoute" value="<?php echo e(route('super_admin.ticket.assign-member')); ?>">
            ...
            <div id="ticketPaginationWrap" class="d-flex justify-content-center mt-20 tablePagi"></div>
        </div>
    </div>
    <?php else: ?>
    <div class="section-wrap">
        <div class="p-30 bg-white bd-one bd-c-stroke bd-ra-10 text-center">
            <h4 class="pb-22 fs-24 fw-500 lh-30 text-center"><?php echo e(__('There is no tickets available here!')); ?></h4>
            <a href="#" class="primary-btn" data-bs-toggle="modal" data-bs-target="#addTicketModal">+
...
<div class="modal fade" id="addTicketModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <?php echo $__env->make('auto_posts.super_admin.ticket.add-new', ['paymentOrderList' => $paymentOrderList, 'teamMemberList'
            => $teamMemberList], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
...
<script src="<?php echo e(asset('super_admin/js/ticket.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\ticket\list.blade.php ENDPATH**/ ?>