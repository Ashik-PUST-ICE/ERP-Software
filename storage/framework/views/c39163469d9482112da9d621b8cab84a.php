    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="card-box">
            ...
            <div class="card-info">
                ...
                <h3><?php echo e(__('Invoice Total')); ?></h3>
            </div>
            <span class="card-status up"><?php echo e(__('Total Billed')); ?> <span class="arrow"><i class="fa-solid fa-arrow-up"></i></span></span>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="card-box">
            ...
            <div class="card-info">
                ...
                <h3><?php echo e(__('Collected')); ?></h3>
            </div>
            <span class="card-status up"><?php echo e(__('Total Received')); ?> <span class="arrow"><i class="fa-solid fa-arrow-up"></i></span></span>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="card-box">
            ...
            <div class="card-info">
                ...
                <h3><?php echo e(__('Receivable')); ?></h3>
            </div>
            <span class="card-status up"><?php echo e(__('Outstanding Balance')); ?> <span class="arrow"><i class="fa-solid fa-arrow-up"></i></span></span>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="card-box">
            ...
            <div class="card-info">
                ...
                <h3><?php echo e(__('Payable Entries')); ?></h3>
            </div>
            <span class="card-status up"><?php echo e(__('Accounts Payable')); ?> <span class="arrow"><i class="fa-solid fa-arrow-up"></i></span></span>
        </div>
    </div>
</div>
            ...
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="<?php echo e(__('Search Receivables...')); ?>" />
                </div>
                <input type="hidden" id="ap-ar-data-route" value="<?php echo e(route('admin.garments.ap-ar.index')); ?>">
                <table class="display primary-table dataTable dtr-inline" id="apArDataTable">
                    <thead>
                        <tr>
                            ...
                            <th class="keep-show"><?php echo e(__('Status')); ?></th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
...
<script src="<?php echo e(asset('admin/js/garment-ap-ar.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\admin\garments\ap-ar\index.blade.php ENDPATH**/ ?>