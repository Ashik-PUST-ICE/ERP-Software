    ...
    <div class="d-flex flex-column gap-3">
        ...
        <div class="bg-white border rounded p-3">
            <div class="d-flex align-items-center gap-2 mb-2 ticket-client-image-wrapper">
                ...
                <?php else: ?>
                <h4 class="fs-13 fw-600 lh-18 text-title-black mb-0"><?php echo e($item->client_name); ?></h4>
                <?php endif; ?>
            </div>
            <div class="mb-2">
...
<div class="section-wrap mt-20">
    ...
    <form class="ajax reset" action="<?php echo e(route('admin.ticket.conversations.store')); ?>" method="POST"
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-10 write-replay-radio-box" style="column-gap: 20px; margin-bottom: 20px">
                                ...
                                <div class="zForm-wrap-checkbox-2">
                                    <input type="radio" name="status"
                                        ...
                                        value="<?php echo e(TICKET_STATUS_CLOSED); ?>" data-status="<?php echo e($ticketDetails->status); ?>" />
...
<input type="hidden" id="statusChangeRoute" value="<?php echo e(route('admin.ticket.status.change')); ?>"><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\ticket\conversation.blade.php ENDPATH**/ ?>