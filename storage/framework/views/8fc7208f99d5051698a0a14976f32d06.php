...
<div class="section-title"><h2 class="title"><?php echo e(__($title)); ?></h2><a href="<?php echo e(route('admin.roles.index')); ?>" class="primary-btn btn-secondary"><i class="fa fa-arrow-left me-2"></i><?php echo e(__('Back to Roles')); ?></a></div>

<div class="rp-page mt-4">
    <div class="rp-hero d-flex align-items-center justify-content-between gap-4">
        <div class="d-flex align-items-center gap-3 position-relative" style="z-index:1"><div class="rp-icon"><i class="fa-solid fa-shield-halved"></i></div><div><div class="rp-eyebrow"><?php echo e(__('Access Control')); ?></div><h3 class="rp-title"><?php echo e($role->display_name); ?></h3><div class="rp-subtitle"><?php echo e(__('Configure permissions for this role')); ?></div></div></div>
        <div class="d-flex position-relative" style="z-index:1"><div class="rp-stat"><strong id="selected-permission-count"><?php echo e($selectedPermissions->count()); ?></strong><span><?php echo e(__('Selected permissions')); ?></span></div><div class="rp-stat"><strong><?php echo e($totalPermissions); ?></strong><span><?php echo e(__('Available permissions')); ?></span></div></div>
    </div>

    <form data-handler="commonResponse" action="<?php echo e(route('admin.roles.update.permissions', [$role->id])); ?>" method="POST" class="ajax">
        <?php echo method_field('put'); ?> <?php echo csrf_field(); ?>
        <div class="rp-body">
            <aside class="rp-modules"><div class="rp-modules-title"><?php echo e(__('Permission Modules')); ?></div>
                <div class="rp-module-list">
                    <?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $modulePermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <button type="button" class="rp-module <?php echo e($loop->first ? 'active' : ''); ?>" data-module="<?php echo e($module); ?>"><span><i class="fa-solid fa-layer-group"></i><?php echo e(moduleName($module)); ?></span><span class="rp-module-count"><?php echo e(collect($modulePermissions)->count()); ?></span></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <div class="rp-empty"><?php echo e(__('No modules found.')); ?></div> <?php endif; ?>
                </div>
                <div class="rp-module-pagination"></div>
            </aside>
            <main class="rp-content">
                <div class="rp-content-head"><div><h3><?php echo e(__('Role permissions')); ?></h3><p><?php echo e(__('Choose what this role can access in the admin panel.')); ?></p></div><div class="rp-search"><i class="fa-solid fa-magnifying-glass"></i><input type="search" id="permission-search" placeholder="<?php echo e(__('Search permissions...')); ?>"><button type="button" class="rp-clear-search" id="clear-permission-search"><i class="fa-solid fa-xmark"></i></button></div></div>
                <?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $modulePermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <section class="rp-section module-content <?php echo e($loop->first ? '' : 'd-none'); ?>" data-module="<?php echo e($module); ?>"><div class="rp-section-title"><div><h4><?php echo e(moduleName($module)); ?></h4><span><?php echo e(collect($modulePermissions)->count()); ?> <?php echo e(__('permissions available')); ?></span></div><button type="button" class="rp-select-all module-select-all" data-module="<?php echo e($module); ?>"><?php echo e(__('Select all')); ?></button></div><div class="rp-grid">
                        <?php $__currentLoopData = $modulePermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="rp-permission permission-item <?php echo e($selectedPermissions->contains($permission->id) ? 'checked' : ''); ?>" for="permission-<?php echo e($permission->id); ?>"><input <?php echo e($selectedPermissions->contains($permission->id) ? 'checked' : ''); ?> class="permission-checkbox" type="checkbox" name="permissions[]" value="<?php echo e($permission->name); ?>" id="permission-<?php echo e($permission->id); ?>"><span><?php echo e($permission->display_name); ?></span></label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div><div class="rp-pagination"></div></section>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <div class="rp-empty"><?php echo e(__('No permissions available.')); ?></div> <?php endif; ?>
                <div class="rp-footer"><span class="rp-footer-note"><i class="fa-solid fa-circle-info me-1"></i><?php echo e(__('Changes apply to users assigned to this role.')); ?></span><button type="submit" class="rp-save"><i class="fa-solid fa-check me-2"></i><?php echo e(__('Save Permissions')); ?></button></div>
            </main>
        </div>
    </form>
</div>
...
$(function () {
    ...
    function renderPagination(section, total, page) {
        ...
        let html = '<span class="rp-pagination-info">' + total + ' <?php echo e(__('results')); ?></span>';
    ...
    function updateCount() {
        ...
        $('.module-content:visible').each(function () {
            ...
            button.text(boxes.length && boxes.filter(':checked').length === boxes.length ? <?php echo json_encode(__('Clear all'), 15, 512) ?> : <?php echo json_encode(__('Select all'), 15, 512) ?>);
        });
    }
...
<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\roles\permissions.blade.php ENDPATH**/ ?>