...
<?php echo e(__('Dynamic Menus')); ?>

<?php $__env->stopPush(); ?>
<?php $__env->startSection('content'); ?>
<div class="section-title">
    <h2 class="title"><?php echo e(__('Dynamic Menus')); ?></h2>
    ...
    <div class="settings-page-right">
        <div class="section-wrap">
            <div class="table-waraper">
                ...
                <input type="hidden" id="menu-data-route" value="<?php echo e(route('super_admin.setting.menu.dynamic.list')); ?>">
...
<div class="modal fade" id="addMenuModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form class="ajax reset" action="<?php echo e(route('super_admin.setting.menu.dynamic.store')); ?>" method="post"
                data-handler="commonResponseWithPageLoad">
                <?php echo csrf_field(); ?>
                <div class="modal-body zModalTwo-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0"><?php echo e(__('Add New Menu')); ?></h4>
                        <div class="mClose">
                    ...
                    <div class="primary-form">
                        <div class="row gy-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label"><?php echo e(__('Page')); ?><span class="required">*</span></label>
                                    <select name="url" id="menuUrl" class="form-control" required>
                                        <option value="">--<?php echo e(__('Select Page')); ?>--</option>
                                        <?php $__currentLoopData = $urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($page->id); ?>"><?php echo e($page->en_title); ?></option>
...
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\menu\dynamic-menu-list.blade.php ENDPATH**/ ?>