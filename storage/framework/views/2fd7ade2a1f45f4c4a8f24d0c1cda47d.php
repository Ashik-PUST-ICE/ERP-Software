<form class="ajax reset" action="<?php echo e(route('admin.team-members.update', $user->id)); ?>" method="post" data-handler="commonResponseWithPageLoad">
    <?php echo csrf_field(); ?>
    <?php echo method_field('PUT'); ?>
    <div class="modal-body zModalTwo-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0"><?php echo e(__('Edit Team Member')); ?></h4>
            <div class="mClose">
            ...
            <div class="row gy-3">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="password" minlength="6" placeholder="<?php echo e(__('Leave blank to keep current password')); ?>">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select class="form-control select wide" name="role_id" required>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($role->id); ?>" <?php if($user->roles->contains('id', $role->id)): echo 'selected'; endif; ?>><?php echo e($role->display_name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                <div class="col-12">
...
<?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\users\edit.blade.php ENDPATH**/ ?>