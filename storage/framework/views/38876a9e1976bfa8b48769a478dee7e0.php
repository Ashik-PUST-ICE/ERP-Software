...
<div class="section-title d-flex justify-content-between align-items-center">
    <div>
        <h2 class="title mb-1"><?php echo e(__($title)); ?></h2>
        <p class="text-muted mb-0"><?php echo e(__('Choose a template and send an email in a few clicks.')); ?></p>
    </div>
    <button type="button" class="primary-btn d-inline-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#send-template-modal" data-template-id="">
        <i class="fa-solid fa-pen-to-square"></i><?php echo e(__('Custom Email')); ?>
    ...
    <div class="settings-page-right w-100">
        <div class="section-wrap email-template-panel">
            <div class="email-panel-heading">
                <div>
                    <h5 class="email-section-title mb-1"><span></span><i class="fa-solid fa-layer-group"></i><?php echo e(__('Email Templates')); ?></h5>
                    <p class="text-muted mb-0"><?php echo e(__('Click any card to open the email composer with the template ready.')); ?></p>
                </div>
                <div class="d-flex align-items-center gap-3 flex-wrap"><div class="email-variable-list"><code>&#123;&#123;name&#125;&#125;</code><code>&#123;&#123;email&#125;&#125;</code><code>&#123;&#123;date&#125;&#125;</code></div><button type="button" class="primary-btn-outline template-manage-btn" data-bs-toggle="modal" data-bs-target="#template-management-modal"><i class="fa-solid fa-sliders me-1"></i><?php echo e(__('Manage Templates')); ?></button></div>
            </div>
            <div class="row g-3 mt-1">
                <?php $__empty_1 = true; $__currentLoopData = $activeTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-md-6 col-xl-4">
                        <button type="button" class="email-template-card w-100 text-start" data-bs-toggle="modal" data-bs-target="#send-template-modal" data-template-id="<?php echo e($template->id); ?>">
                            <div class="email-card-icon"><i class="fa-solid <?php echo e(['fa-hand-sparkles', 'fa-receipt', 'fa-bell', 'fa-shirt'][$loop->index % 4]); ?>"></i></div>
                            <div class="email-card-content">
                                <h6><?php echo e($template->name); ?></h6>
                                <p><?php echo e(\Illuminate\Support\Str::limit($template->subject, 64)); ?></p>
                                <span><?php echo e(__('Use template')); ?> <i class="fa-solid fa-arrow-right"></i></span>
                            </div>
                        </button>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-12"><div class="email-empty-state"><i class="fa-regular fa-folder-open"></i><p><?php echo e(__('No active email templates found.')); ?></p></div></div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="section-wrap mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h5 class="email-section-title mb-1"><span></span><i class="fa-solid fa-clock-rotate-left"></i><?php echo e(__('Email History')); ?></h5>
                    <small class="text-muted"><?php echo e(__('Pending emails are handled by the queue worker.')); ?></small>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table align-middle email-history-table">
                    <thead><tr><th><?php echo e(__('Recipient')); ?></th><th><?php echo e(__('Subject')); ?></th><th><?php echo e(__('Status')); ?></th><th><?php echo e(__('Date')); ?></th><th class="text-end"><?php echo e(__('Action')); ?></th></tr></thead>
                            <tbody id="email-history-body">
                                <tr><td colspan="5" class="text-muted text-center py-4"><i class="fa-solid fa-spinner fa-spin me-2"></i><?php echo e(__('Loading email history...')); ?></td></tr>
                            </tbody>
                </table>
            </div>
...
<div class="modal fade zModalTwo" id="template-management-modal" tabindex="-1" aria-labelledby="template-management-modal-label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl template-management-dialog">
        <div class="modal-content zModalTwo-content">
            <div class="modal-header zModalTwo-header template-management-header"><div><h5 class="modal-title mb-1" id="template-management-modal-label"><i class="fa-solid fa-sliders me-2"></i><?php echo e(__('Manage Email Templates')); ?></h5><small><?php echo e(__('Create reusable email messages for your daily work.')); ?></small></div><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo e(__('Close')); ?>"></button></div>
            <div class="modal-body zModalTwo-body template-management-body">
                <form id="template-management-form" method="POST" action="<?php echo e(route('admin.email.templates.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="_method" id="template-form-method" value="POST">
                    <input type="hidden" id="template-store-route" value="<?php echo e(route('admin.email.templates.store')); ?>">
                    <input type="hidden" id="template-update-route" value="<?php echo e(route('admin.email.templates.update', ['id' => '__ID__'])); ?>">
                    <div class="template-editor-card"><div class="template-editor-heading"><div><h6><?php echo e(__('Template details')); ?></h6><p><?php echo e(__('Use variables like name, email or date to personalize your message.')); ?></p></div><span class="template-editor-badge"><i class="fa-solid fa-pen-to-square"></i><?php echo e(__('Editor')); ?></span></div><div class="row gy-3">
                        <div class="col-md-6"><label class="form-label"><?php echo e(__('Template Name')); ?> <span class="required">*</span></label><input type="text" name="name" id="template_name" class="form-control" required></div>
                        <div class="col-md-6"><label class="form-label"><?php echo e(__('Subject')); ?> <span class="required">*</span></label><input type="text" name="subject" id="template_subject" class="form-control" required></div>
                        <div class="col-12"><label class="form-label"><?php echo e(__('Message')); ?> <span class="required">*</span></label><textarea name="body" id="template_body" class="form-control" rows="6" required></textarea></div>
                        <div class="col-md-8"><label class="form-label"><?php echo e(__('Variables')); ?></label><input type="text" name="variables" id="template_variables" class="form-control" placeholder="&#123;&#123;name&#125;&#125;, &#123;&#123;email&#125;&#125;, &#123;&#123;date&#125;&#125;"></div>
                        <div class="col-md-4 d-flex align-items-end"><label class="template-active-toggle"><input type="checkbox" name="status" id="template_status" value="1" checked><span></span><?php echo e(__('Active template')); ?></label></div>
                    </div></div>
                    <div class="template-manage-actions mt-3"><button type="button" class="primary-btn-outline" id="template-new-btn"><i class="fa-solid fa-plus me-1"></i><?php echo e(__('New Template')); ?></button><div class="d-flex gap-2"><button type="button" class="primary-btn-outline" data-bs-dismiss="modal"><?php echo e(__('Cancel')); ?></button><button type="submit" class="primary-btn" id="template-save-btn"><i class="fa-solid fa-check me-1"></i><?php echo e(__('Save Template')); ?></button></div></div>
                </form>
                <div class="template-list-heading"><div><h6><?php echo e(__('Saved templates')); ?></h6><p><?php echo e(__('Edit or remove a template whenever you need.')); ?></p></div><span><i class="fa-solid fa-layer-group"></i> <?php echo e($templates->count()); ?> <?php echo e(__('templates')); ?></span></div>
                <div class="template-list">
                    <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="template-list-item">
                            <div class="template-list-icon"><i class="fa-solid fa-envelope-open-text"></i></div>
                            <div class="template-list-info"><div class="d-flex align-items-center gap-2 flex-wrap"><strong><?php echo e($template->name); ?></strong><span class="template-status <?php echo e($template->status ? 'is-active' : 'is-inactive'); ?>"><?php echo e($template->status ? __('Active') : __('Inactive')); ?></span></div><div class="template-list-subject"><?php echo e(\Illuminate\Support\Str::limit($template->subject, 90)); ?></div><div class="template-list-vars"><?php echo e($template->variables ?: __('No variables added')); ?></div></div>
                            <div class="template-list-actions"><button type="button" class="btn btn-sm btn-outline-primary template-edit-btn" data-template-id="<?php echo e($template->id); ?>"><i class="fa-solid fa-pen-to-square me-1"></i><?php echo e(__('Edit')); ?></button><form id="delete-template-<?php echo e($template->id); ?>" method="POST" action="<?php echo e(route('admin.email.templates.destroy', $template->id)); ?>" class="d-inline"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?></form><button type="button" class="btn btn-sm btn-outline-danger deleteItem" data-formid="delete-template-<?php echo e($template->id); ?>"><i class="fa-regular fa-trash-can me-1"></i><?php echo e(__('Delete')); ?></button></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="template-list-empty"><i class="fa-regular fa-folder-open"></i><span><?php echo e(__('No saved templates yet.')); ?></span></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content zModalTwo-content">
            <div class="modal-header zModalTwo-header">
                <h5 class="modal-title" id="send-template-modal-label"><i class="fa-solid fa-paper-plane me-2"></i><?php echo e(__('Send Email')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo e(__('Close')); ?>"></button>
            </div>
            <form action="<?php echo e(route('admin.email.send')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body zModalTwo-body">
                    <input type="hidden" name="template_id" id="modal_template_id" value="">
                    <div class="email-selected-template" id="selected-template-name"><i class="fa-solid fa-pen-to-square"></i><?php echo e(__('Custom email')); ?></div>
                    <div class="row gy-3">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                <label class="form-label"><?php echo e(__('Recipients')); ?> <span class="required">*</span></label>
                                <input type="text" name="recipients" value="<?php echo e(old('recipients')); ?>" class="form-control" placeholder="name@example.com, another@example.com" required>
                                <small class="text-muted"><?php echo e(__('Separate multiple addresses with comma, semicolon or space.')); ?></small>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label"><?php echo e(__('Subject')); ?> <span class="required">*</span></label>
                                <input type="text" name="subject" id="modal_email_subject" value="<?php echo e(old('subject')); ?>" class="form-control" maxlength="255">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <label class="form-label"><?php echo e(__('Message')); ?> <span class="required">*</span></label>
                                <textarea name="message" id="modal_email_message" rows="9" class="form-control"><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-5">
                            <div class="email-modal-preview">
                                <div class="email-modal-preview-heading"><i class="fa-solid fa-eye"></i><?php echo e(__('Email Preview')); ?></div>
                                <div class="email-modal-preview-subject" id="modal_preview_subject"><?php echo e(__('Your subject will appear here')); ?></div>
                                <div class="email-modal-preview-message" id="modal_preview_message"><?php echo e(__('Your message preview will appear here.')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer zModalTwo-footer">
                    <button type="button" class="primary-btn-outline" data-bs-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
                    <button type="submit" class="primary-btn d-inline-flex align-items-center gap-2"><i class="fa-solid fa-paper-plane"></i><?php echo e(__('Send Email')); ?></button>
                </div>
            </form>
        </div>
    </div>
</div>
<input type="hidden" id="email-history-route" value="<?php echo e(route('admin.email.history')); ?>">
<input type="hidden" id="email-retry-route" value="<?php echo e(route('admin.email.retry', ['id' => '__ID__'])); ?>">
<input type="hidden" id="email-app-name" value="<?php echo e(getOption('app_name')); ?>">
<script type="application/json" id="email-templates-data"><?php echo json_encode($templateData, 15, 512) ?></script>
...
<script src="<?php echo e(asset('admin/js/email-center.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\email\index.blade.php ENDPATH**/ ?>