      ...
      <div class="menu-wrapr">
        <ul id="metismenu" class="primary-menu metismenu">
          ...
          <li class="<?php echo e(isset($activeUserPackages) && $activeUserPackages == 'active' ? 'currrent-menu' : ''); ?>">
            <a href="<?php echo e(route('super_admin.packages.user')); ?>">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12.6663 13.6667C12.6663 11.0893 10.577 9 7.99967 9C5.42235 9 3.33301 11.0893 3.33301 13.6667"
                  stroke="#808080" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
          ...
          <li class="<?php echo e(isset($activeRoles) && $activeRoles == 'active' ? 'currrent-menu' : ''); ?>">
            <a class="has-arrow" href="#role-permission-menu" data-bs-toggle="collapse" role="button"
                aria-expanded="<?php echo e(isset($showRolePermission) ? 'true' : 'false'); ?>"
            ...
            <ul id="role-permission-menu" class="collapse <?php echo e(isset($showRolePermission) ? 'show' : ''); ?>">
              <li><a class="<?php echo e(isset($activeRoles) && $activeRoles == 'active' ? 'active' : ''); ?>" href="<?php echo e(route('super_admin.roles.index')); ?>"><?php echo e(__('Roles')); ?></a></li>
            </ul>
          </li>

          <li class="divider"><span><?php echo e(__('System Configuration')); ?></span></li>
          <li class="<?php echo e((isset($activeApplicationSetting) || isset($activeConfigurationSetting) || isset($activeLandingPageSettings)) ? 'currrent-menu' : ''); ?>">
            ...
            <ul id="settings-menu" class="collapse <?php echo e(isset($showManageApplicationSetting) ? 'show' : ''); ?>">
              <li><a class="<?php echo e(isset($activeApplicationSetting) && $activeApplicationSetting == 'active' ? 'active' : ''); ?>" href="<?php echo e(route('super_admin.setting.application-settings')); ?>"><?php echo e(__('General Setting')); ?></a></li>
              <li><a class="<?php echo e(isset($activeConfigurationSetting) && $activeConfigurationSetting == 'active' ? 'active' : ''); ?>" href="<?php echo e(route('super_admin.setting.configuration-settings')); ?>"><?php echo e(__('Configuration Settings')); ?></a></li>
              <li><a class="<?php echo e(isset($activeLandingPageSettings) && $activeLandingPageSettings == 'active' ? 'active' : ''); ?>" href="<?php echo e(route('super_admin.setting.frontend.landing-page.hero')); ?>"><?php echo e(__('Landing Page')); ?></a></li>
            </ul>
          </li>
...
<?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\user\layouts\sidebar.blade.php ENDPATH**/ ?>