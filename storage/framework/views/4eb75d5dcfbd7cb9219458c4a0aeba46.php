        ...
        <div class="section-wrap">
            <div class="section-inner-title">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="title"><?php echo e(__('Currency Settings')); ?></h3>
                    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
                        <i class="fa fa-plus me-2"></i><?php echo e(__('Add Currency')); ?>
            ...
            <div class="table-waraper">
                <div class="search-input-wrap">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="<?php echo e(__('Search By Currency...')); ?>" />
                </div>
                <div id="currencies-table-container" data-pagination-route="<?php echo e(route('super_admin.setting.currencies.index')); ?>">
                    <?php echo $__env->make('auto_posts.super_admin.setting.currencies.partials.currencies_table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <form class="ajax reset" action="<?php echo e(route('super_admin.setting.currencies.store')); ?>" method="post"
                data-handler="currencyHandler">
                <?php echo csrf_field(); ?>
                <div class="modal-body zModalTwo-body">
                    <!-- Header -->
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0"><?php echo e(__('Add Currency')); ?></h4>
                        <div class="mClose">
                        ...
                        <div class="row gy-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="currency_code" class="form-label"><?php echo e(__('Currency ISO Code')); ?><span
                                    ...
                                    <select id="sf-select-currency-add"
                                        ...
                                        <option value="<?php echo e($code); ?>"><?php echo e($currencyItem); ?> (<?php echo e($code); ?>)</option>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="symbol" class="form-label"><?php echo e(__('Symbol')); ?><span
                                            class="required">*</span></label>
                                    <input type="text" class="form-control" name="symbol" id="symbol"
                                        placeholder="<?php echo e(__('Enter currency symbol')); ?>" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="currency_placement"
                                        class="form-label"><?php echo e(__('Currency Placement')); ?><span
                                            class="required">*</span></label>
                                    <select class="select form-control wide sf-select-without-search"
                                        ...
                                        <option value="before"><?php echo e(__('Before Amount')); ?></option>
                                        <option value="after"><?php echo e(__('After Amount')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12">
...
<div class="modal fade zModalTwo" id="edit-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <form class="ajax reset" action="<?php echo e(route('super_admin.setting.currencies.update', 0)); ?>" method="post"
                ...
                <div class="modal-body zModalTwo-body">
                    ...
                    <div class="primary-form">
                        <div class="row gy-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="currency_code-edit"
                                        class="form-label"><?php echo e(__('Currency ISO Code')); ?><span
                                            class="required">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="symbol-edit" class="form-label"><?php echo e(__('Symbol')); ?><span
                                            class="required">*</span></label>
...
<script src="<?php echo e(asset('admin/js/common-pagination.js')); ?>"></script>
<script src="<?php echo e(asset('admin/js/currencies.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\setting\currencies\index.blade.php ENDPATH**/ ?>