...
<div class="section-title">
    ...
    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
        <i class="fa fa-plus me-2"></i><?php echo e(__('Add Role')); ?>
...
<div class="settings-page-area">
    ...
    <div class="settings-page-right">
        <div class="section-wrap">
            ...
            <div class="table-waraper">
                <div class="search-input-wrap">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="<?php echo e(__('Search By Role...')); ?>" />
                </div>
                <input type="hidden" id="roles-data-route" value="<?php echo e(route('super_admin.roles.index')); ?>">
                <table class="display primary-table dataTable dtr-inline" id="rolesDataTable">
                    <thead>
                        <tr>
                            <th class="keep-show"><?php echo e(__("SL")); ?></th>
                            <th><?php echo e(__("Role Name")); ?></th>
                            <th><?php echo e(__("Total Permissions")); ?></th>
            ...
            <div id="roles-pagination-wrap" class="d-flex justify-content-center mt-20 tablePagi"></div>
        </div>
    </div>
</div>
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <form class="ajax reset" action="<?php echo e(route('super_admin.roles.store')); ?>" method="post"
                data-handler="commonResponseWithPageLoad">
                <?php echo csrf_field(); ?>
                <div class="modal-body zModalTwo-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0"><?php echo e(__('Add New Role')); ?></h4>
                        <div class="mClose">
                        ...
                        <div class="row gy-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="name" class="form-label"><?php echo e(__('Role Name')); ?><span
                                            class="required">*</span></label>
                                    <input type="text" class="form-control" name="name" id="name"
                                        placeholder="<?php echo e(__('Enter role name')); ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="<?php echo e(asset('super_admin/js/roles.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('auto_posts.super_admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\super_admin\roles\index.blade.php ENDPATH**/ ?>