...
<div class="section-title">
    ...
    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
        <i class="fa fa-plus me-2"></i><?php echo e(__('Mark Attendance')); ?>
            ...
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="<?php echo e(__('Search Production Attendance...')); ?>" />
                </div>
                <input type="hidden" id="production-attendance-route" value="<?php echo e(route('admin.garments.production-attendance.index')); ?>">
                <table class="display primary-table dataTable dtr-inline" id="garmentProductionAttendanceDataTable">
                    <thead>
                        <tr>
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <?php echo $__env->make('admin.garments.production-attendance.form', ['attendance' => null, 'employees' => $employees, 'orders' => $orders], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
...
<script>
$(function() {
    var table = $('#garmentProductionAttendanceDataTable').DataTable({
        pageLength: 10,
        ordering: false,
        serverSide: true,
        processing: true,
        responsive: true,
        dom: 't',
        ajax: $('#production-attendance-route').val(),
        columns: [
            { data: 'sl', name: 'id' },
            ...
            { data: 'production_quantity', name: 'production_quantity' },
...
<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\admin\garments\production-attendance\index.blade.php ENDPATH**/ ?>