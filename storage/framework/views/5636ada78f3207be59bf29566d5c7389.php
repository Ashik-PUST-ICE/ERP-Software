...
<header class="header-area">
    <div class="header-left">
        ...
        <div class="search-area">
            <div class="search-area-wrap">
                ...
                <input type="text" class="search-input" id="searchDataHeader" data-search-url="<?php echo e(route('admin.search')); ?>"
                    placeholder="<?php echo e(__('Search buyers, orders, invoices...')); ?>" autocomplete="off" />
    ...
    <div class="header-right">
        ...
        <div class="dropdown language-dropdown">
            <button class="language-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="language-flag-text">
                    <?php if(selectedLanguage()?->flag): ?>
                    <img class="flag" src="<?php echo e(asset(selectedLanguage()->flag)); ?>"
                        alt="<?php echo e(selectedLanguage()?->language); ?>">
                    <?php endif; ?>
                    <span class="selected-text"><?php echo e(selectedLanguage()?->language ?? __('Language')); ?></span>
                </div>
                <i class="fa-solid fa-angle-down"></i>
            </button>
            <ul class="dropdown-menu dropdown-menu-end">
                <?php $__currentLoopData = $appLangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app_lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <a class="dropdown-item <?php echo e(selectedLanguage()?->iso_code === $app_lang->iso_code ? 'active' : ''); ?>"
                        href="<?php echo e(url('/local/' . $app_lang->iso_code)); ?>">
                        <?php if($app_lang->flag): ?>
                        <img src="<?php echo e(asset($app_lang->flag)); ?>" alt="<?php echo e($app_lang->language); ?>">
                        <?php endif; ?>
        ...
        <div class="dropdown notifications-dropdown">
            <button class="notifications-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-label="<?php echo e(__('Notifications')); ?>">
                <i class="fa-regular fa-bell"></i>
                <?php if($headerUnreadNotifications > 0): ?><span class="notifications-badge"><?php echo e($headerUnreadNotifications > 9 ? '9+' : $headerUnreadNotifications); ?></span><?php endif; ?>
            </button>
            <div class="dropdown-menu dropdown-menu-end">
                <div class="d-flex justify-content-between align-items-center mb-2"><strong><?php echo e(__('Notifications')); ?></strong><small class="text-muted"><?php echo e($headerUnreadNotifications); ?> <?php echo e(__('unread')); ?></small></div>
                <ul class="notifications-list">
                    <?php $__empty_1 = true; $__currentLoopData = $headerNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li><div class="notifications-text"><i class="fa-regular fa-bell"></i><p class="mb-0 <?php echo e($notification->view_status ? '' : 'fw-bold'); ?>"><?php echo e($notification->title ?: __('Notification')); ?><small class="d-block text-muted"><?php echo e(\Illuminate\Support\Str::limit($notification->body, 60)); ?></small><?php if($notification->link): ?><a href="<?php echo e($notification->link); ?>" class="see-more-btn"><?php echo e(__('See More')); ?></a><?php endif; ?></p></div><span class="notifications-time"><?php echo e($notification->created_at->diffForHumans()); ?></span></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <li class="text-center py-3"><p class="text-muted mb-0"><?php echo e(__('No notifications')); ?></p></li>
                    <?php endif; ?>
                </ul>
                <a href="<?php echo e(route('admin.garments.notifications.index')); ?>" class="primary-btn"><?php echo e(__('View all notifications')); ?></a>
            </div>
        </div>
        <!-- <div class="dropdown notifications-dropdown">
            <button class="notifications-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <span class="notifications-badge"><?php echo e($unreadNotificationsCount); ?></span>
                <?php endif; ?>
            </button>
                        ...
                        <div class="notifications-text">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#141B34" stroke-width="0.975" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                            ...
                            <p>
                                ...
                                <a href="<?php echo e($notification->link); ?>" class="see-more-btn"><?php echo e(__('See More')); ?></a>
                                <?php endif; ?>
                            </p>
                        </div>
                        <span class="notifications-time"><?php echo e($notification->created_at->diffForHumans()); ?></span>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <li class="text-center py-3">
                        <p class="text-muted mb-0"><?php echo e(__('No notifications')); ?></p>
                    </li>
                    <?php endif; ?>
                </ul>
                <a href="#" class="primary-btn"><?php echo e(__('All Notifications')); ?></a>
            </div>
        </div> -->
        ...
        <div class="dropdown profile-dropdown">
            <button class="profile-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="profile-avatar">
                    <img src="<?php echo e(getFileUrl(auth()->user()->image)); ?>" alt="<?php echo e(auth()->user()->name); ?>"
                        onerror="this.src='<?php echo e(asset('assets/images/avatar-image.png')); ?>'">
                </div>
                <div class="profile-info">
                    <h4><?php echo e(__('Welcome')); ?></h4>
                    <h3><?php echo e(auth()->user()->name); ?> <i class="fa-solid fa-angle-down"></i></h3>
                </div>
            </button>
            <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item"
                        href="<?php echo e(auth()->user()->role == USER_ROLE_SUPER_ADMIN ? route('super_admin.profile.index') : route('admin.profile.index')); ?>">
...
<?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\layouts\nav.blade.php ENDPATH**/ ?>