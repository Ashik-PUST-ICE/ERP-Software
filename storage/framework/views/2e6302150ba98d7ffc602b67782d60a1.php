...
<div class="section-title">
    ...
    <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
        <i class="fa fa-plus me-2"></i><?php echo e(__('Add User Role')); ?>
    ...
    <div class="settings-page-right">
        <div class="section-wrap">
            ...
            <div class="table-waraper">
                ...
                <input type="hidden" id="roles-data-route" value="<?php echo e(route('admin.roles.index')); ?>">
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <form class="ajax reset" action="<?php echo e(route('admin.roles.store')); ?>" method="post"
                data-handler="commonResponseWithPageLoad">
                <?php echo csrf_field(); ?>
                <div class="modal-body zModalTwo-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fs-20 fw-500 lh-38 text-1b1c17 mb-0"><?php echo e(__('Add New User Role')); ?></h4>
                        <div class="mClose">
...
<script src="<?php echo e(asset('admin/js/roles.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\roles\index.blade.php ENDPATH**/ ?>