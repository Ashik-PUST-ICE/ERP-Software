<?php $__env->startPush('title'); ?>
    <?php echo e(getOption('app_name', 'Autopost')); ?> - <?php echo e($blog->title); ?>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="hero-content-wrapper">
                        <div class="top">
                            <ul class="breadcrum">
                                ...
                                <li> / <?php echo e(__('Blog Single')); ?></li>
                            </ul>
                            <h1 class="title"><?php echo e($blog->title); ?></h1>
                        </div>
                        <div class="bottom">
                            <div class="info">
                                <div class="name"><?php echo e(getOption('landing_blog_author_name', 'Admin')); ?></div>
                                <p class="position"><?php echo e(getOption('landing_blog_author_title', 'Editor')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="blog-iamge">
                        <img src="<?php echo e(getFileUrl($blog->image)); ?>"
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="content">
                        ...
                        <?php else: ?>
                            <p><?php echo e(__('Content will be available soon.')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="blog-sidebar">
                        ...
                        <?php if($blog->date): ?>
                            <div class="meta-item">
                                ...
                                <span class="value"><?php echo e($blog->date); ?></span>
                            </div>
                        <?php endif; ?>

                        <div class="share-section">
                            <span class="label"><?php echo e(__('Share')); ?></span>
...
<?php echo $__env->make('auto_posts.frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\frontend\blog-details.blade.php ENDPATH**/ ?>