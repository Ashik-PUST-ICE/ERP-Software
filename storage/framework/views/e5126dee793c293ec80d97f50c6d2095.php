<div id="queue-assistant" class="queue-assistant" data-status-url="<?php echo e(route('admin.queue.status')); ?>" data-start-url="<?php echo e(route('admin.queue.start')); ?>" data-retry-url="<?php echo e(route('admin.queue.failed.retry', ['id' => '__ID__'])); ?>" data-forget-url="<?php echo e(route('admin.queue.failed.forget', ['id' => '__ID__'])); ?>" data-csrf="<?php echo e(csrf_token()); ?>">
    <button type="button" class="queue-assistant-launcher" aria-label="<?php echo e(__('Open Queue Center')); ?>" aria-expanded="false">
        <i class="fa-solid fa-layer-group"></i><span><?php echo e(__('Queue Center')); ?></span>
    </button>
    <section class="queue-assistant-panel" aria-label="<?php echo e(__('Queue Center')); ?>" hidden>
        <header class="queue-assistant-header">
            <div><strong><?php echo e(__('Queue Center')); ?></strong><small><?php echo e(__('Monitor background tasks')); ?></small></div>
            <button type="button" class="queue-assistant-close" aria-label="<?php echo e(__('Close')); ?>">&times;</button>
        </header>
        <div class="queue-assistant-body">
            <div class="queue-assistant-status-row"><span><?php echo e(__('Connection')); ?></span><strong id="queue-connection">—</strong></div>
            <div class="queue-assistant-cards">
                <div class="queue-assistant-card"><strong id="queue-pending">0</strong><span><?php echo e(__('Pending')); ?></span></div>
                <div class="queue-assistant-card failed"><strong id="queue-failed">0</strong><span><?php echo e(__('Failed')); ?></span></div>
            </div>
            <div class="queue-assistant-ready" id="queue-ready"><i class="fa-solid fa-circle-check"></i><?php echo e(__('Queue database is ready')); ?></div>
            <button type="button" class="queue-assistant-run" id="queue-run"><i class="fa-solid fa-play"></i> <?php echo e(__('Run Pending Jobs Now')); ?></button>
            ...
            <div class="queue-failed-section" id="queue-failed-section" hidden>
                <div class="queue-failed-title"><?php echo e(__('Recent failed jobs')); ?></div>
                <div id="queue-failed-list"></div>
            </div>
            <div class="queue-assistant-command-label"><?php echo e(__('Run this command in a Herd terminal')); ?></div>
            <div class="queue-assistant-command"><code id="queue-command">php artisan queue:work --queue=default --tries=3 --timeout=120</code><button type="button" id="queue-copy-command" title="<?php echo e(__('Copy command')); ?>"><i class="fa-regular fa-copy"></i></button></div>
            <p class="queue-assistant-note"><?php echo e(__('Keep the worker terminal running while emails or other background tasks are being processed.')); ?></p>
            <div class="queue-assistant-footer"><small id="queue-checked-at"><?php echo e(__('Not checked yet')); ?></small><button type="button" class="queue-assistant-refresh" id="queue-refresh"><i class="fa-solid fa-rotate"></i> <?php echo e(__('Refresh')); ?></button></div>
        </div>
    </section>
</div>
...
<?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\layouts\queue-assistant.blade.php ENDPATH**/ ?>