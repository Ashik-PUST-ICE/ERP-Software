<style>
    :root {
        ...
        --sidebar-hover-text-color: #FF4F02;
        <?php else: ?>
        ...
        --colorOne: <?php echo e(getOption('app_text_secondary_color', '#707070')); ?>;
        --bColor: <?php echo e(getOption('app_text_secondary_color', '#707070')); ?>;
        --hover-color: <?php echo e(getOption('app_hover_color', '#d93900')); ?>;
        --black: <?php echo e(getOption('app_text_color', '#000000')); ?>;
        --sidebar-text-color: <?php echo e(getOption('app_sidebar_text_color', '#e7e3e3')); ?>;
        --sidebar-bg-color: <?php echo e(getOption('app_sidebar_bg_color', '#1b1c17')); ?>;
        --sidebar-hover-text-color: <?php echo e(getOption('app_sidebar_text_color', '#FF4F02')); ?>ef;
        <?php endif; ?>
        --colorTwo: #ebedf0;
        --colorThree: #fafafa;
        --colorFour: #71e3ba;
...
<?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\layouts\dynamic-color.blade.php ENDPATH**/ ?>