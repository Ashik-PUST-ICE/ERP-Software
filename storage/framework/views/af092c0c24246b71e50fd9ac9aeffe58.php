...
<div class="section-title">
    ...
    <div class="d-flex align-items-center gap-2">
        <a href="<?php echo e(route('admin.garments.materials.scanner')); ?>" class="primary-btn-outline"><i class="fa-solid fa-barcode me-2"></i><?php echo e(__('Scanner')); ?></a>
        <button type="button" class="primary-btn" data-bs-toggle="modal" data-bs-target="#add-modal"><i class="fa fa-plus me-2"></i><?php echo e(__('Add Material')); ?></button>
    </div>
</div>
            ...
            <div class="table-waraper">
                <div class="search-input-wrap mb-3">
                    ...
                    <input type="text" class="search-input" id="searchData"
                        placeholder="<?php echo e(__('Search materials, barcodes or category...')); ?>" />
                </div>
                <input type="hidden" id="garment-material-data-route" value="<?php echo e(route('admin.garments.materials.index')); ?>">
                <table class="display primary-table dataTable dtr-inline" id="garmentMaterialDataTable">
                    <thead>
                        <tr>
...
<div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content zModalTwo-content">
            <?php echo $__env->make('admin.garments.materials.form', ['material' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
...
<script src="<?php echo e(asset('admin/js/garment-materials.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('auto_posts.admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ashik\ERP-Software\resources\views\admin\garments\materials\index.blade.php ENDPATH**/ ?>