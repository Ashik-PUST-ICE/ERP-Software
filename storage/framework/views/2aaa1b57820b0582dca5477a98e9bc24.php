<head>
    ...
    <?php echo $__env->make('auto_posts.admin.layouts.dynamic-color', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->yieldPushContent('style'); ?>
    <style>
        <?php echo getOption('custom_css'); ?>

    </style>
<link rel="stylesheet" href="<?php echo e(asset('admin/css/header-extra.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('admin/css/garment-dashboard.css')); ?>?ver=<?php echo e(env('VERSION', 0)); ?>">
...
<?php /**PATH C:\Users\ashik\ERP-Software\resources\views\auto_posts\admin\layouts\header.blade.php ENDPATH**/ ?>